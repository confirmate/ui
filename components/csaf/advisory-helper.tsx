...
export default function AdvisoryHelper({ requests, result }: AdvisoryHelperProps) {
    ...
    return <div className="space-x-2">
        {advisory !== undefined ?
            <Link href={`/certification-targets/${result.certificationTargetId}/advisories/${advisory.id}`}><Button className="bg-gray-800 hover:bg-gray-600">Advisory Exists</Button></Link> :
